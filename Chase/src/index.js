...
<div class="flex-container">
    <div class="column-left align-center" id="left-container">
        ...
        <br /><br />
        <div style="padding: 0 !important; margin: 0 !important" id="divone">
            <my-video id="custom-video"></my-video>
        </div>
...
class VideoDisplayApp extends HTMLElement {
    constructor() {
        ...
        this._vidControl = this._shadowRoot.getElementById('custom-video');

        this._divone = this._shadowRoot.getElementById('divone');
        ...
        this._vidControl.addEventListener("play", this.playVideo.bind(this));

        this._vidControl.addEventListener("pause", this.pauseVideo.bind(this));
    ...
    scrollEvent(e) {
        var position = {
            height: String(this._divone.clientHeight),
            width: String(this._divone.clientWidth),
    ...
    playVideo(e) {
        console.log('Listened to play event');
        console.log(e);
    ...
    pauseVideo(e) {
        console.log('Listened to pause event');
        console.log(e);
        this._playButton.disabled = false;
        this._pauseButton.disabled = true;
    }
...
window.customElements.define('video-app', VideoDisplayApp);
